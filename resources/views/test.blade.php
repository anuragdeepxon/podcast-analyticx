...
<head>
    ...
    <link href="{{ url('vendor/animate/animate.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('vendor/aos/css/aos.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('vendor/aos/css/aos.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('vendor/bootstrap-daterangepicker/daterangepicker.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('vendor/bootstrap-datetimepicker/css/bootstrap-datetimepicker.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('vendor/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('vendor/bootstrap-multiselect/css/bootstrap-multiselect.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('vendor/bootstrap-select/dist/css/bootstrap-select.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('vendor/bootstrap-tagsinput/css/bootstrap-tagsinput.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('vendor/bootstrap-touchspin/css/jquery.bootstrap-touchspin.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('vendor/bootstrap-v4-rtl/scss/app.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('vendor/chartist/css/chartist.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('vendor/chartist-plugin-tooltips/css/chartist-plugin-tooltip.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('vendor/clockpicker/css/bootstrap-clockpicker.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('vendor/datatables/css/jquery.dataTables.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('vendor/deznav/deznav.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('vendor/dropzone/dist/dropzone.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('vendor/dropzone/dist/basic.css') }}" rel="stylesheet" type="text/css" />
    
    <link href="{{ url('vendor//app.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('vendor//app.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('vendor//app.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('vendor//app.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('vendor//app.css') }}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{ url('css/backend/perfect-scrollbar.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('css/backend/style.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('css/backend/style.css.map') }}" rel="stylesheet" type="text/css" />
